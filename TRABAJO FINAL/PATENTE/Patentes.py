...
while True:
    ...
    cv2.rectangle(frame, (870, 750), (1070, 850), (0, 0, 0), cv2.FILED)
    ...
    # Primero los ordenamos del mas grande al ams pequeño
    ...
    for contorno in contornos:
        ...
        if area > 500 and area < 5000:
            ...
            # Convertimos la matris en imagen
            bin = bin.reshape(alt, anp)
            bin = Image.fronarray(bin)
            bin = bin.convert("L")

            # Nos aseguramos de tener un buen tamaño de place
